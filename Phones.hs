...
phoneToString (P Voiced (Tongue _ Apical Central) Postalveolar (Stop Tenuis) Oral) = "d̠"
phoneToString (P Voiced (Tongue _ Apical Central) Postalveolar (Stop Tenuis) Nasal) = "ⁿd̠"
phoneToString (P Voiceless (Tongue _ Apical Central) Postalveolar (Stop Tenuis) Oral) = "t̠"
phoneToString (P VoicedIngressive (Tongue _ Apical Central) Postalveolar (Stop Tenuis) Oral) = "ɗ̠"
phoneToString (P Voiced (Tongue _ Apical Central) Postalveolar NasalStop Nasal) = "n̠"
...
phoneToString (P Voiced (Tongue _ Apical Central) Postalveolar Trill Oral) = "r̠"
phoneToString (P Voiced (Tongue _ Apical Central) Postalveolar Tap Oral) = "ɾ̠"
phoneToString (P Voiced (Tongue _ Apical Central) Postalveolar Approximant Oral) = "ɹ̠"
phoneToString (P Voiced (Tongue _ Apical Lateral) Postalveolar Approximant Oral) = "l̠"
-- palatoalveolars
